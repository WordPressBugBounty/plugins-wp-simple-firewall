...
namespace AptowebDeps\FG\ASN1;

use AptowebDeps\FG\ASN1\Exception\ParserException;
use AptowebDeps\FG\ASN1\Universal\BitString;
use AptowebDeps\FG\ASN1\Universal\Boolean;
use AptowebDeps\FG\ASN1\Universal\Enumerated;
use AptowebDeps\FG\ASN1\Universal\GeneralizedTime;
use AptowebDeps\FG\ASN1\Universal\Integer;
use AptowebDeps\FG\ASN1\Universal\NullObject;
use AptowebDeps\FG\ASN1\Universal\ObjectIdentifier;
use AptowebDeps\FG\ASN1\Universal\RelativeObjectIdentifier;
use AptowebDeps\FG\ASN1\Universal\OctetString;
use AptowebDeps\FG\ASN1\Universal\Sequence;
use AptowebDeps\FG\ASN1\Universal\Set;
use AptowebDeps\FG\ASN1\Universal\UTCTime;
use AptowebDeps\FG\ASN1\Universal\IA5String;
use AptowebDeps\FG\ASN1\Universal\PrintableString;
use AptowebDeps\FG\ASN1\Universal\NumericString;
use AptowebDeps\FG\ASN1\Universal\UTF8String;
use AptowebDeps\FG\ASN1\Universal\UniversalString;
use AptowebDeps\FG\ASN1\Universal\CharacterString;
use AptowebDeps\FG\ASN1\Universal\GeneralString;
use AptowebDeps\FG\ASN1\Universal\VisibleString;
use AptowebDeps\FG\ASN1\Universal\GraphicString;
use AptowebDeps\FG\ASN1\Universal\BMPString;
use AptowebDeps\FG\ASN1\Universal\T61String;
use AptowebDeps\FG\ASN1\Universal\ObjectDescriptor;
use AptowebDeps\FG\Utility\BigInteger;
use LogicException;
...
abstract class ASNObject implements Parsable
{
     ...
     *
     * @return \AptowebDeps\FG\ASN1\ASNObject
     */
