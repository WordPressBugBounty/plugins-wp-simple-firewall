...
use AptowebDeps\FG\ASN1\Exception\NotImplementedException;
...
{
    /**
     * @param string|\AptowebDeps\FG\ASN1\Universal\ObjectIdentifier $objIdentifierString
    ...
    {
        /** @var \AptowebDeps\FG\ASN1\ASNObject $firstObject */
