...
namespace AptowebDeps\FG\X509;

use AptowebDeps\FG\ASN1\Exception\ParserException;
use AptowebDeps\FG\ASN1\OID;
use AptowebDeps\FG\ASN1\ASNObject;
use AptowebDeps\FG\ASN1\Parsable;
use AptowebDeps\FG\ASN1\Identifier;
...
use AptowebDeps\FG\X509\SAN\SubjectAlternativeNames;
...
class CertificateExtensions extends Set implements Parsable
{
    ...
    public static function fromBinary(&$binaryData, &$offsetIndex = 0)
    {
        ...
        foreach ($extensions as $extension) {
            ...
            /** @var \AptowebDeps\FG\ASN1\ASNObject $objectIdentifier */
