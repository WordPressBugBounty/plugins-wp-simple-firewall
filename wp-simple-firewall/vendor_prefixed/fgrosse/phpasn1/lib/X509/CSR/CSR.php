...
namespace AptowebDeps\FG\X509\CSR;
...
use AptowebDeps\FG\X509\CertificateSubject;
use AptowebDeps\FG\X509\AlgorithmIdentifier;
use AptowebDeps\FG\X509\PublicKey;
