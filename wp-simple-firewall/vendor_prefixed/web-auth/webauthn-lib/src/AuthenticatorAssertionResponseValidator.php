...
use AptowebDeps\CBOR\Decoder;
use AptowebDeps\CBOR\OtherObject\OtherObjectManager;
use AptowebDeps\CBOR\Tag\TagObjectManager;
use AptowebDeps\Cose\Algorithm\Manager;
use AptowebDeps\Cose\Algorithm\Signature\Signature;
use AptowebDeps\Cose\Key\Key;
use function count;
...
use AptowebDeps\Webauthn\Counter\ThrowExceptionIfInvalid;
use AptowebDeps\Webauthn\TokenBinding\TokenBindingHandler;
use AptowebDeps\Webauthn\Util\CoseSignatureFixer;
