...
use function AptowebDeps\Safe\parse_url;
use function AptowebDeps\Safe\sprintf;
use Throwable;
use AptowebDeps\Webauthn\AttestationStatement\AttestationObject;
use AptowebDeps\Webauthn\AttestationStatement\AttestationStatement;
...
use AptowebDeps\Webauthn\AuthenticationExtensions\AuthenticationExtensionsClientOutputs;
use AptowebDeps\Webauthn\AuthenticationExtensions\ExtensionOutputCheckerHandler;
use AptowebDeps\Webauthn\CertificateChainChecker\CertificateChainChecker;
use AptowebDeps\Webauthn\MetadataService\MetadataStatement;
use AptowebDeps\Webauthn\MetadataService\MetadataStatementRepository;
use AptowebDeps\Webauthn\MetadataService\StatusReport;
use AptowebDeps\Webauthn\TokenBinding\TokenBindingHandler;
use AptowebDeps\Webauthn\TrustPath\CertificateTrustPath;
use AptowebDeps\Webauthn\TrustPath\EmptyTrustPath;
