...
namespace AptowebDeps\Webauthn\AttestationStatement;

use AptowebDeps\Assert\Assertion;
use AptowebDeps\Base64Url\Base64Url;
...
use AptowebDeps\Cose\Algorithms;
use AptowebDeps\Cose\Key\Ec2Key;
use AptowebDeps\Cose\Key\Key;
use AptowebDeps\Cose\Key\OkpKey;
use AptowebDeps\Cose\Key\RsaKey;
use function count;
use function in_array;
use InvalidArgumentException;
use function is_array;
use RuntimeException;
use AptowebDeps\Safe\DateTimeImmutable;
use function AptowebDeps\Safe\sprintf;
use function AptowebDeps\Safe\unpack;
use AptowebDeps\Webauthn\AuthenticatorData;
use AptowebDeps\Webauthn\CertificateToolbox;
use AptowebDeps\Webauthn\StringStream;
use AptowebDeps\Webauthn\TrustPath\CertificateTrustPath;
use AptowebDeps\Webauthn\TrustPath\EcdaaKeyIdTrustPath;
