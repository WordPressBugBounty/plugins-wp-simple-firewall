...
use AptowebDeps\Safe\Exceptions\FilesystemException;
use function AptowebDeps\Safe\file_put_contents;
use function AptowebDeps\Safe\ksort;
use function AptowebDeps\Safe\mkdir;
use function AptowebDeps\Safe\rename;
use function AptowebDeps\Safe\sprintf;
use function AptowebDeps\Safe\tempnam;
use function AptowebDeps\Safe\unlink;
use AptowebDeps\Symfony\Component\Process\Process;

class CertificateToolbox
{
    /**
     * @deprecated "This method is deprecated since v3.3 and will be removed en v4.0. Please use AptowebDeps\Webauthn\CertificateChainChecker\CertificateChainChecker instead"
     *
