 ...
 *
 *      $logger = new \AptowebDeps\Monolog\Logger('all', array(new \AptowebDeps\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['AptowebDeps\\Monolog\\'], // array Hide calls of classes started with...
