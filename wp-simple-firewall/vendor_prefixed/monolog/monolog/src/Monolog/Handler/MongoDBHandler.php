...
use AptowebDeps\Monolog\Formatter\MongoDBFormatter;
 ...
 * Usage example:
 *
 *   $log = new \AptowebDeps\Monolog\Logger('application');
 *   $client = new \MongoDB\Client('mongodb://localhost:27017');
 *   $mongodb = new \AptowebDeps\Monolog\Handler\MongoDBHandler($client, 'logs', 'prod');
