...
namespace AptowebDeps\Safe;

use AptowebDeps\Safe\Exceptions\ArrayException;
use AptowebDeps\Safe\Exceptions\FilesystemException;
use AptowebDeps\Safe\Exceptions\JsonException;
use AptowebDeps\Safe\Exceptions\MiscException;
use AptowebDeps\Safe\Exceptions\OpensslException;
use AptowebDeps\Safe\Exceptions\SplException;
use AptowebDeps\Safe\Exceptions\StringsException;
use AptowebDeps\Safe\Exceptions\UrlException;
