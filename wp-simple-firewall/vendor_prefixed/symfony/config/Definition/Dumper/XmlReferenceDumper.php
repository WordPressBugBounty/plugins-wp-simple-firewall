...
namespace AptowebDeps\Symfony\Component\Config\Definition\Dumper;

use AptowebDeps\Symfony\Component\Config\Definition\ArrayNode;
use AptowebDeps\Symfony\Component\Config\Definition\BaseNode;
                ...
                if ($prototype instanceof PrototypedArrayNode) {
                    ...
                    if ($prototype->hasDefaultValue()) {
                        ...
                        switch (\get_class($prototype)) {
                            case 'AptowebDeps\Symfony\Component\Config\Definition\ScalarNode':
                                $prototypeValue = 'scalar value';
                                break;

                            case 'AptowebDeps\Symfony\Component\Config\Definition\FloatNode':
                            case 'AptowebDeps\Symfony\Component\Config\Definition\IntegerNode':
                                $prototypeValue = 'numeric value';
                                break;

                            case 'AptowebDeps\Symfony\Component\Config\Definition\BooleanNode':
                                $prototypeValue = 'true|false';
                                break;

                            case 'AptowebDeps\Symfony\Component\Config\Definition\EnumNode':
