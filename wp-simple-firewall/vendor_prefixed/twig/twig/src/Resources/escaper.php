 ...
 */
function aptowebdeps_pfx_twig_raw_filter($string)
{
 ...
 * @deprecated since Twig 3.9
 */
function aptowebdeps_pfx_twig_escape_filter(Environment $env, $string, $strategy = 'html', $charset = null, $autoescape = false)
{
    trigger_deprecation('twig/twig', '3.9', 'Using the internal "%s" function is deprecated.', __FUNCTION__);
 ...
 * @deprecated since Twig 3.9
 */
function aptowebdeps_pfx_twig_escape_filter_is_safe(Node $filterArgs)
{
    trigger_deprecation('twig/twig', '3.9', 'Using the internal "%s" function is deprecated.', __FUNCTION__);
