...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler
                ->write("use AptowebDeps\Twig\Environment;\n")
                ->write("use AptowebDeps\Twig\Error\LoaderError;\n")
                ->write("use AptowebDeps\Twig\Error\RuntimeError;\n")
                ->write("use AptowebDeps\Twig\Extension\CoreExtension;\n")
                ->write("use AptowebDeps\Twig\Extension\SandboxExtension;\n")
                ->write("use AptowebDeps\Twig\Markup;\n")
                ->write("use AptowebDeps\Twig\Sandbox\SecurityError;\n")
                ->write("use AptowebDeps\Twig\Sandbox\SecurityNotAllowedTagError;\n")
                ->write("use AptowebDeps\Twig\Sandbox\SecurityNotAllowedFilterError;\n")
                ->write("use AptowebDeps\Twig\Sandbox\SecurityNotAllowedFunctionError;\n")
                ->write("use AptowebDeps\Twig\Source;\n")
                ->write("use AptowebDeps\Twig\Template;\n\n")
            ;
        }
        $compiler
