...
namespace AptowebDeps\CBOR\Tag;

use AptowebDeps\CBOR\CBORObject;
use AptowebDeps\CBOR\NegativeIntegerObject;
use AptowebDeps\CBOR\Normalizable;
...
use AptowebDeps\CBOR\Tag;
use AptowebDeps\CBOR\UnsignedIntegerObject;
