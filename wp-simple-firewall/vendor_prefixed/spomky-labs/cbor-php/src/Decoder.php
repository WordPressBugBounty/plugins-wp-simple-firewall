...
namespace AptowebDeps\CBOR;

use AptowebDeps\CBOR\OtherObject\BreakObject;
use AptowebDeps\CBOR\OtherObject\DoublePrecisionFloatObject;
use AptowebDeps\CBOR\OtherObject\FalseObject;
use AptowebDeps\CBOR\OtherObject\HalfPrecisionFloatObject;
use AptowebDeps\CBOR\OtherObject\NullObject;
use AptowebDeps\CBOR\OtherObject\OtherObjectManager;
use AptowebDeps\CBOR\OtherObject\OtherObjectManagerInterface;
use AptowebDeps\CBOR\OtherObject\SimpleObject;
use AptowebDeps\CBOR\OtherObject\SinglePrecisionFloatObject;
use AptowebDeps\CBOR\OtherObject\TrueObject;
use AptowebDeps\CBOR\OtherObject\UndefinedObject;
use AptowebDeps\CBOR\Tag\Base16EncodingTag;
use AptowebDeps\CBOR\Tag\Base64EncodingTag;
use AptowebDeps\CBOR\Tag\Base64Tag;
use AptowebDeps\CBOR\Tag\Base64UrlEncodingTag;
use AptowebDeps\CBOR\Tag\Base64UrlTag;
use AptowebDeps\CBOR\Tag\BigFloatTag;
use AptowebDeps\CBOR\Tag\CBOREncodingTag;
use AptowebDeps\CBOR\Tag\CBORTag;
use AptowebDeps\CBOR\Tag\DatetimeTag;
use AptowebDeps\CBOR\Tag\DecimalFractionTag;
use AptowebDeps\CBOR\Tag\MimeTag;
use AptowebDeps\CBOR\Tag\NegativeBigIntegerTag;
use AptowebDeps\CBOR\Tag\TagManager;
use AptowebDeps\CBOR\Tag\TagManagerInterface;
use AptowebDeps\CBOR\Tag\TimestampTag;
use AptowebDeps\CBOR\Tag\UnsignedBigIntegerTag;
use AptowebDeps\CBOR\Tag\UriTag;
