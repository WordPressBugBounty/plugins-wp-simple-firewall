...
class MapDir {
	...
	public function run() :void {
		foreach ( $this->enumDirs() as $dir ) {
			try {
				( new MapDir( $this->map, $this->tracker, $this->filter, $dir, $this->hashAlgo, $this->stopAtTS, $this->rootDir ) )->run();
			}
