...
namespace FernleafSystems\Wordpress\Services\TP\BackgroundProcessing;

/**
 * Lock-in version of 1.3.1 while we debug the issues introduced with 1.4.0
 */
...
abstract class WP_Background_Process extends WP_Async_Request {
	 ...
	 *
	 * @param bool|array $allowed_batch_data_classes Optional. Array of class names that can be unserialized. Default
	 *                                               true (any class).
	 */
