...
use AptowebDeps\Twig\TokenParser\AutoEscapeTokenParser;
...
final class EscaperExtension extends AbstractExtension
{
    ...
    public function setEnvironment(Environment $environment, bool $triggerDeprecation = true): void
    {
        if ($triggerDeprecation) {
            trigger_deprecation('twig/twig', '3.10', 'The "%s()" method is deprecated and not needed if you are using methods from "AptowebDeps\Twig\Runtime\EscaperRuntime".', __METHOD__);
        }
    ...
    {
        trigger_deprecation('twig/twig', '3.10', 'The "%s()" method is deprecated, use the "AptowebDeps\Twig\Runtime\EscaperRuntime::getEscaper()" method instead.', __METHOD__);
